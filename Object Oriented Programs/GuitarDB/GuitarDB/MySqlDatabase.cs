...
{
    /* This manages all our communications with the backend MySql database.
     */
    class MySqlDatabase
    {
        ...
        public bool CloseConnection(ref string errmsg)
        {
            ...
            ConnectionOpen = false; /*even if we failed to close the connection the connection,
                                     * probably shouldn't be used anymore, because and error occured.*/
            return result;
        }
        ...
        /* Connection must be open before calling this function */
